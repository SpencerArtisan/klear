...
struct Provider: IntentTimelineProvider {
    func placeholder(in context: Context) -> SimpleEntry {
        return SimpleEntry(date: Date(), configuration: ConfigurationIntent(), isPreview: true)
    }
    ...
    func getTimeline(for configuration: ConfigurationIntent, in context: Context, completion: @escaping (Timeline<Entry>) -> ()) {
        print("Construct timeline for \(configuration.List)")
        
        // Create a timeline entry for "now."
        let date = Date()
        let entry = SimpleEntry(date: date, configuration: configuration, isPreview: false)
...
struct KlearWidgetEntryView : View {
    ...
    fileprivate func colourScheme() -> [UIColor] {
        let scheme = entry.configuration.Colour
        switch (scheme) {
...
struct KlearWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("Klear Widget")
        .description("The Klear list widget.")
...
struct KlearWidget_Previews: PreviewProvider {
    static var previews: some View {
        KlearWidgetEntryView(entry: SimpleEntry(date: Date(), configuration: ConfigurationIntent(), isPreview: true))
